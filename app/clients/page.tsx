...
function ClientsPageContent() {
  ...
  async function createClient(assignToCurrentUser?: boolean) {
    if (
      clientType === "B2C" &&
        ...
        <header>
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex rounded-xl bg-emerald-500 px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-400"
            >
              + Dodaj klienta
            </button>
          </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div ref={filtersPanelRef} className="relative w-full sm:w-[280px]">
              ...
              {showFiltersPanel && (
                <div className="absolute right-0 top-full z-40 mt-2 max-h-[520px] w-[360px] overflow-y-auto rounded-2xl border border-slate-200 bg-white p-4 shadow-2xl">
          ...
          <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="rounded-xl bg-emerald-500 px-5 py-3 text-sm font-bold text-white hover:bg-emerald-400"
              >
                Tak
              </button>
            </div>
